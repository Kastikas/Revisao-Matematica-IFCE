 ...
 * Contém os 6 blocos, 41 subtópicos e 293 exercícios com resoluções KaTeX.
 */
const mathData = {
  "1": {
    ...
    "topics": [
      ...
      },
      {
        ...
        "solvedExample": {
          ...
          "solution": "Seja $x$ as notas de $\\text{R\\$} 5$ e $y$ as notas de $\\text{R\\$} 20$:\n$\\begin{cases} x + y = 47 \\\\ 5x + 20y = 580 \\end{cases}$\nMultiplicando a 1ª por $-5$: $-5x - 5y = -235$.\nSomando: $15y = 345 \\Rightarrow y = 23$ notas de $\\text{R\\$} 20$.\n$x = 47 - 23 = 24$ notas de $\\text{R\\$} 5$."
        },
        "questions": [
          {
  ...
  "6": {
    ...
    "description": "Resoluções completas, gabaritos comentados e simulados das 5 provas mais recentes do processo seletivo do IFCE (Cursos Técnicos Integrados).",
    "icon": "award",
    "topics": [
      {
